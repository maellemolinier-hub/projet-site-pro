...
SECTEURS: dict[str, Secteur] = {
    ...
    "couvreur": Secteur("couvreurs", "l'Assistant IA BTP"),
    "platrier_carreleur": Secteur("plâtriers-carreleurs", "l'Assistant IA BTP"),
    ...
    "jardinier": Secteur("jardiniers-paysagistes", "l'Assistant IA Jardin & Paysage"),
    ...
    "vtc": Secteur("chauffeurs VTC", "l'Assistant IA VTC"),
